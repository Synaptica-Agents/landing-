...
export function Statement() {
  return (
    <section className="relative isolate overflow-hidden min-h-screen flex items-center justify-center px-6 snap-start bg-gradient-to-b from-white via-blue-100 to-blue-300">
      <LightSectionWaves />
