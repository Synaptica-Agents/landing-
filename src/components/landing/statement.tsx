...
export function Statement() {
  return (
    <section data-theme="light" className="relative isolate overflow-hidden min-h-screen flex items-center justify-center px-6 snap-start bg-gradient-to-b from-white from-60% via-blue-100 via-85% to-blue-300">
      <LightSectionWaves />
