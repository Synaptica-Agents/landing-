...
export function Hero() {
  ...
  return (
    <section className="min-h-screen flex items-center justify-center px-6 pt-20 snap-start">
      <div className="w-full max-w-7xl flex flex-col md:flex-row items-center gap-8 md:gap-8">
        {/* Spline 3D */}
        <div className="w-full md:flex-1 h-[320px] md:h-[620px] relative overflow-hidden">
          <SplineScene
            scene="https://prod.spline.design/XcyEqCFug5N9OvlL/scene.splinecode"
            className="w-full h-full scale-125 md:scale-[1.4]"
